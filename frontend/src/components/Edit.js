    ...
    <div className="m-5">
      ...
      <div className="flex">
        ...
        <div>
          ...
          <button type="button" onClick={() => save()} className="bg-blue-400 text-white p-2 mr-2 my-3 rounded">Save</button>
          <button type="button" onClick={() => navigate(-1)} className="bg-slate-400 text-white p-2 my-3 rounded">Back to Images</button>
        </div>
      </div>
    </div>
  )
